...
from .views import RegisterView, LoginView, StudentDeleteView, StudentListView, TeacherView ,TeacherListView,TeacherDeleteView,TeacherUpdateView,ChangePasswordView, RegisterView, LoginView, UserProfileView
